            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        @if(config('easy_panel.crud.category.delete') or config('easy_panel.crud.category.update'))
                        <td>{{ __('Action') }}</td>
                        @endif
                    </tr>
