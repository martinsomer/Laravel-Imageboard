...
class Read extends Component
{
    ...
    protected $listeners = ['replyDeleted'];
    ...
    public function render()
    {
        ...
        if(config('easy_panel.crud.reply.search')){
            $array = (array) config('easy_panel.crud.reply.search');
        ...
        return view('livewire.admin.reply.read', [
            'replys' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Reply')) ]);
    }
}
