...
class Read extends Component
{
    ...
    protected $listeners = ['boardDeleted'];

    public $sortType;
    public $sortColumn;

    public function boardDeleted(){
        // Nothing ..
    }
    ...
    public function render()
    {
        ...
        if(config('easy_panel.crud.board.search')){
            $array = (array) config('easy_panel.crud.board.search');
        ...
        return view('livewire.admin.board.read', [
            'boards' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Board')) ]);
    }
}
